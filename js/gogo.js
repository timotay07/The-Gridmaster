$(document).ready(function(){
    ...
    $("#xAxis").prepend('<div class="group fill"></div>');
    for (i = 0; i < numCols; i++) {
        $("#xAxis > div").prepend('<div class="cols"></div>');
    }
